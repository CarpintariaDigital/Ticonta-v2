...
def get_informal_customer(
    ...
    service = InformalSalesService(db)
    return service.get_customer(customer_id=id, company_id=tenant_id)
...
def update_informal_customer(
    ...
    service = InformalSalesService(db)
    return service.update_customer(customer_id=id, data=data, company_id=tenant_id)
...
def create_sale_with_debit(
    ...
    """
    service = InformalSalesService(db)
    return service.create_sale_with_debit(data=data, user_id=tenant_id)
...
def get_customer_debit_summary(
    ...
    service = InformalSalesService(db)
    return service.get_customer_debits_summary(customer_id=id, company_id=tenant_id)
...
def get_overdue_debits(
    ...
    service = InformalSalesService(db)
    return service.get_overdue_debits(company_id=tenant_id)
...
def get_credit_risk_report(
    ...
    service = InformalSalesService(db)
    return service.get_credit_risk_report(company_id=tenant_id)
...
def get_cash_flow_forecast(
    ...
    service = InformalSalesService(db)
    return service.get_cash_flow_forecast(company_id=tenant_id)
...
def get_revenue_breakdown(
    ...
    service = InformalSalesService(db)
    return service.get_revenue_breakdown(company_id=tenant_id)
