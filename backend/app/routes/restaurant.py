...
async def websocket_kds_endpoint(
    ...
    role: str = Query(default="kitchen")
):
    """
...
def list_tables(
    ...
    return service.list_tables(company_id=tenant_id, status_filter=status, location_filter=location)
...
def create_table(
    ...
    service = RestaurantService(db)
    return service.create_table(data=data, company_id=tenant_id)
...
def get_table(
    ...
    service = RestaurantService(db)
    return service.get_table(table_id=id, company_id=tenant_id)
...
def update_table(
    ...
    service = RestaurantService(db)
    return service.update_table(table_id=id, data=data, company_id=tenant_id)
...
def update_table_status(
    ...
    service = RestaurantService(db)
    return service.update_table_status(table_id=id, new_status=data.status, company_id=tenant_id)
...
def release_expired_reservations(
    ...
    service = RestaurantService(db)
    count = service.release_expired_reservations(company_id=tenant_id, grace_minutes=grace_minutes)
...
def list_menu_items(
    ...
    service = RestaurantService(db)
    return service.list_menu_items(company_id=tenant_id, category=category, available_only=available_only)
...
def create_menu_item(
    ...
    service = RestaurantService(db)
    return service.create_menu_item(data=data, company_id=tenant_id)
...
def get_menu_item(
    ...
    service = RestaurantService(db)
    return service.get_menu_item(item_id=id, company_id=tenant_id)
...
def update_menu_item(
    ...
    service = RestaurantService(db)
    return service.update_menu_item(item_id=id, data=data, company_id=tenant_id)
...
def list_orders(
    ...
    service = RestaurantService(db)
    orders = service.list_orders(company_id=tenant_id, status_filter=status, table_id=table_id)
...
def get_order(
    ...
    service = RestaurantService(db)
    order = service.get_order(order_id=id, company_id=tenant_id)
    return _format_order_response(order)
...
def update_item_status(
    ...
    service = RestaurantService(db)
    item = service.update_item_status(order_item_id=id, status_val=data.status, company_id=tenant_id)
    return OrderItemResponse(
        id=item.id,
        order_id=item.order_id,
        menu_item_id=item.menu_item_id,
...
def get_kitchen_display(
    ...
    service = RestaurantService(db)
    return service.get_kitchen_display(company_id=tenant_id)
...
def get_table_bill(
    ...
    service = RestaurantService(db)
    return service.get_table_bill(order_id=id, company_id=tenant_id)
...
def get_restaurant_settings(
    ...
    service = RestaurantService(db)
    return service.get_or_create_settings(company_id=tenant_id)
...
def update_restaurant_settings(
    ...
    service = RestaurantService(db)
    return service.update_settings(company_id=tenant_id, data=data)
