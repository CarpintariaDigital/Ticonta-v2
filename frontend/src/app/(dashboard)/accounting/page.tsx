        ...
        <header className="border-b border-zinc-800 bg-zinc-900/60 backdrop-blur px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400">PGC-NIRF • Sistema Financeiro Moçambique</p>
            </div>
          </div>
        ...
        <main className="flex-1 max-w-7xl w-full mx-auto p-6 space-y-6">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <Link
              ...
              className="group rounded-2xl border border-zinc-800 bg-zinc-900/50 p-5 hover:border-emerald-500/50 hover:bg-zinc-900 transition-all"
            >
            ...
            <Link
              ...
              className="group rounded-2xl border border-zinc-800 bg-zinc-900/50 p-5 hover:border-blue-500/50 hover:bg-zinc-900 transition-all"
            >
              <div className="flex items-center justify-between">
            ...
            <Link
              ...
              className="group rounded-2xl border border-zinc-800 bg-zinc-900/50 p-5 hover:border-purple-500/50 hover:bg-zinc-900 transition-all"
            >
              <div className="flex items-center justify-between">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-4">
              <span className="text-xs text-zinc-400 font-medium uppercase">Movimento Total Débito</span>
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-4">
              <span className="text-xs text-zinc-400 font-medium uppercase">Movimento Total Crédito</span>
              <p className="text-2xl font-black text-white mt-1">
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-4">
              <span className="text-xs text-zinc-400 font-medium uppercase">Rendimentos do Exercício</span>
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-4">
              <span className="text-xs text-zinc-400 font-medium uppercase">Resultado Líquido</span>
