...
export const DualBarcodeScanner: React.FC<DualBarcodeScannerProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-between bg-black/90 text-white p-4 backdrop-blur-md font-mono selection:bg-emerald-500 selection:text-black">
      {/* Top Header */}
      <div className="w-full max-w-md flex items-center justify-between py-2 border-b border-zinc-800">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            onClick={onClose}
            className="p-2 rounded-lg bg-zinc-800 border border-zinc-700 text-zinc-300 hover:bg-zinc-700 hover:text-white"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
      ...
      {mode === "stock" && lastScannedCode && (
        <div className="w-full max-w-md bg-zinc-900/95 border border-zinc-800 rounded-2xl p-3.5 space-y-3 mb-2 animate-in fade-in text-white">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <Input
                    ...
                    className="h-8 text-xs bg-zinc-950 border-zinc-700 text-zinc-200 mt-1"
                  />
                </div>
                <div>
