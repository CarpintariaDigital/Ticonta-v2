...
Suporte Carpintaria Digital: +258 84 000 0000`;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-white backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-2xl bg-white border border-zinc-200 rounded-3xl p-6 shadow-2xl overflow-hidden max-h-[92vh] flex flex-col">
        {/* Top Header */}
        <div className="flex items-center justify-between pb-4 border-b border-zinc-200 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-zinc-900">Emitir Chave de Licença Comercial</h2>
              <p className="text-xs text-zinc-500">Planos predefinidos ou módulos selecionados com preços à medida</p>
            </div>
          </div>
          <button
            onClick={resetForm}
          ...
          {!generatedResult ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="md:col-span-2">
                  ...
                  <div className="relative">
                    <Building className="absolute left-3.5 top-2.5 w-4 h-4 text-zinc-500" />
                    <input
                      type="text"
                      required
                      ...
                      className="w-full pl-10 pr-4 py-2 bg-zinc-50/80 border border-zinc-200/80 rounded-xl text-zinc-900 placeholder-slate-500"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-zinc-50/80 border border-zinc-200/80 rounded-xl text-zinc-900 font-mono"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-zinc-50/80 border border-zinc-200/80 rounded-xl text-zinc-900"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2 pt-2 border-t border-zinc-200">
                <label className="block font-semibold text-zinc-700 uppercase tracking-wider">
              ...
              {planMode === "preset" ? (
                ...
                <div className="space-y-3 bg-zinc-50/80 p-4 rounded-2xl border border-zinc-200">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <span className="text-[10px] text-zinc-500">Subtotal Mensal:</span>
                        ...
                        >
                          <label className="flex items-center gap-2 cursor-pointer flex-1 min-w-0 pr-1">
                            <input
                              ...
                              className="rounded border-zinc-200 bg-white text-emerald-500"
                            />
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-zinc-200">
                    ...
                    <div className="text-right">
                      <span className="text-[10px] text-zinc-500">Total a Cobrar ao Cliente:</span>
              ...
              <div className="pt-2 flex items-center justify-end gap-3 border-t border-zinc-200">
                <button
                  type="button"
                  onClick={resetForm}
                  className="px-4 py-2 text-zinc-500 hover:text-zinc-800"
                >
                  Cancelar
                </button>
                <button
            ...
            <div className="space-y-4 text-xs">
              ...
              <div>
                <label className="block text-zinc-500 uppercase tracking-wider mb-1 font-semibold">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="w-full px-3 py-2.5 bg-white font-mono text-sm text-emerald-300 font-bold border border-zinc-200 rounded-xl select-all"
                  />
                  <button
                    type="button"
                    onClick={handleCopy}
