        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-950/60 p-4 space-y-3">
          ...
          <div className="space-y-2 text-xs font-mono">
            {data.revenues_breakdown.map((r) => (
              <div key={r.code} className="flex justify-between border-b border-zinc-800/40 pb-1.5">
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-950/60 p-4 space-y-3">
          ...
          <div className="space-y-2 text-xs font-mono">
            {data.expenses_breakdown.map((e) => (
              <div key={e.code} className="flex justify-between border-b border-zinc-800/40 pb-1.5">
                <span className="text-zinc-300">
