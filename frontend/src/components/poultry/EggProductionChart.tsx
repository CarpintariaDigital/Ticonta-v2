  ...
  return (
    <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-4 md:p-5 shadow-xl backdrop-blur-md space-y-4">
      ...
      <div className="flex items-center justify-between pb-3 border-b border-slate-800">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Curva de rendimento e controle de qualidade</p>
          </div>
        </div>

        <div className="text-right">
          <span className="text-[10px] text-slate-400 uppercase font-semibold block">Taxa de Postura</span>
      ...
      <div className="space-y-2">
        ...
        <div className="h-32 flex items-end justify-between gap-2 pt-4 px-2 bg-slate-950/60 rounded-xl border border-slate-800/80">
      ...
      <div className="grid grid-cols-3 gap-2 pt-1 text-xs">
        <div className="p-2 bg-slate-950 rounded-xl border border-slate-800 text-center">
          <span className="text-[10px] text-slate-400 block">Grau A (Perfeito)</span>
          <span className="text-sm font-extrabold text-emerald-400">{qualityBreakdown.grade_a}%</span>
        </div>

        <div className="p-2 bg-slate-950 rounded-xl border border-slate-800 text-center">
          <span className="text-[10px] text-slate-400 block">Grau B (Médio)</span>
          <span className="text-sm font-extrabold text-amber-400">{qualityBreakdown.grade_b}%</span>
        </div>

        <div className="p-2 bg-slate-950 rounded-xl border border-slate-800 text-center">
          <span className="text-[10px] text-slate-400 block">Grau C (Quebrados)</span>
